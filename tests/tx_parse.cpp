...
#pragma clang diagnostic pop
    ...
    TEST(TxParse, Tx_Chain_not_Allowed) {
        auto transaction = R"({"account_number":"0","chain_id":"0","fee":{"amount":[{"amount":"5","denom":"photon"}],"gas":"10000"},"memo":"testmemo","msgs":[{"inputs":[{"address":"creataaccaddr1d9h8qat5e4ehc5","coins":[{"amount":"10","denom":"cta"}]}],"outputs":[{"address":"creataaccaddr1da6hgur4wse3jx32","coins":[{"amount":"10","denom":"cta"}]}]}],"sequence":"1"})";
    ...
    TEST(TxParse, Tx_Page_Count) {
        auto transaction = R"({"account_number":"0","chain_id":"test-chain-1","fee":{"amount":[{"amount":"5","denom":"photon"}],"gas":"10000"},"memo":"testmemo","msgs":[{"inputs":[{"address":"creataaccaddr1d9h8qat5e4ehc5","coins":[{"amount":"10","denom":"cta"}]}],"outputs":[{"address":"creataaccaddr1da6hgur4wse3jx32","coins":[{"amount":"10","denom":"cta"}]}]}],"sequence":"1"})";
    ...
    TEST(TxParse, Page_Count_MultipleMsgs) {
        auto transaction =
                R"({"account_number":"0","chain_id":"test-chain-1","fee":{"amount":[{"amount":"5","denom":"photon"}],"gas":"10000"},"memo":"testmemo","msgs":[{"inputs":[{"address":"creataaccaddr1d9h8qat5e4ehc5","coins":[{"amount":"10","denom":"cta"}]}],"outputs":[{"address":"creataaccaddr1da6hgur4wse3jx32","coins":[{"amount":"10","denom":"cta"}]}]},{"inputs":[{"address":"creataaccaddr1d9h8qat5e4ehc5","coins":[{"amount":"10","denom":"cta"}]}],"outputs":[{"address":"creataaccaddr1da6hgur4wse3jx32","coins":[{"amount":"10","denom":"cta"}]}]},{"inputs":[{"address":"creataaccaddr1d9h8qat5e4ehc5","coins":[{"amount":"10","denom":"cta"}]}],"outputs":[{"address":"creataaccaddr1da6hgur4wse3jx32","coins":[{"amount":"10","denom":"cta"}]}]},{"inputs":[{"address":"creataaccaddr1d9h8qat5e4ehc5","coins":[{"amount":"10","denom":"cta"}]}],"outputs":[{"address":"creataaccaddr1da6hgur4wse3jx32","coins":[{"amount":"10","denom":"cta"}]}]}],"sequence":"1"})";
