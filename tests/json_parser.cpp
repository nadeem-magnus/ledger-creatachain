...
namespace {
    ...
    TEST(TxValidationTest, ObjectGetValueCorrectFormat) {
        auto transaction =
                R"({"account_number":"0","chain_id":"test-chain-1","fee":{"amount":[{"amount":"5","denom":"photon"}],"gas":"10000"},"memo":"testmemo","msgs":[{"inputs":[{"address":"creatasaccaddr1d9h8qat5e4ehc5","coins":[{"amount":"10","denom":"cta"}]}],"outputs":[{"address":"creatasaccaddr1da6hgur4wse3jx32","coins":[{"amount":"10","denom":"cta"}]}]}],"sequence":"1"})";
        parsed_json_t parsed_json;
        JSON_PARSE(&parsed_json, transaction);
