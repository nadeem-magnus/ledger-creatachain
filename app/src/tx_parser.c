...
static const key_subst_t value_substitutions[] = {
        {"creata-sdk/MsgSend",                        "Send"},
        {"creata-sdk/MsgDelegate",                    "Delegate"},
        {"creata-sdk/MsgUndelegate",                  "Undelegate"},
        {"creata-sdk/MsgBeginRedelegate",             "Redelegate"},
        {"creata-sdk/MsgSubmitProposal",              "Propose"},
        {"creata-sdk/MsgDeposit",                     "Deposit"},
        {"creata-sdk/MsgVote",                        "Vote"},
        {"creata-sdk/MsgWithdrawDelegationReward",    "Withdraw Reward"},
        {"creata-sdk/MsgWithdrawValidatorCommission", "Withdraw Val. Commission"},
        {"creata-sdk/MsgSetWithdrawAddress",          "Withdraw Set Address"},
        {"creata-sdk/MsgMultiSend",                   "Multi Send"},
